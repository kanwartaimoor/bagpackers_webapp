...
class ToursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tour" do
    assert_difference('Tour.count') do
      post tours_url, params: { tour: { comapnay: @tour.comapnay, date: @tour.date, duration: @tour.duration, price: @tour.price, seats: @tour.seats, title: @tour.title } }
    end
  ...
  test "should update tour" do
    patch tour_url(@tour), params: { tour: { comapnay: @tour.comapnay, date: @tour.date, duration: @tour.duration, price: @tour.price, seats: @tour.seats, title: @tour.title } }
